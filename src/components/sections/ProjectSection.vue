<template>
  <section class="py-20 px-4 bg-base-500">
    <h2 class="text-3xl font-bold text-base-content text-center mb-10">
      Projects
    </h2>
...
const projects = [
  ...
  {
    title: "E-commerce UI",
    description: "A modern, responsive UI for an e-commerce store.",
  },
  {
    title: "Landing Page",
    description: "A promotional landing page with animations.",
  },
];
</script>
